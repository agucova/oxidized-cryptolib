...
impl MasterKeyFile {
    ...
    /// - `CryptoError::KeyDerivationFailed`: Scrypt key derivation failed
    /// - `CryptoError::KeyUnwrapIntegrityFailed`: **[INTEGRITY VIOLATION]** Key unwrap failed
    ...
    fn unlock_with_kek(&self, kek: &SecretBox<[u8; 32]>) -> Result<MasterKey, CryptoError> {
        ...
        // Note: unwrap failure indicates INTEGRITY VIOLATION - tampered key file or wrong password
