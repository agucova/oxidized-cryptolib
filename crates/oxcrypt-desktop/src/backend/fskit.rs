...
//! `FSKitBackend` from `oxcrypt-fskit`. Otherwise, it provides a stub
...
//!
//! ```bash
//! cargo build -p oxcrypt-desktop --features fskit
//! ```

// When the fskit feature is enabled, re-export from oxcrypt-fskit
#[cfg(feature = "fskit")]
pub use oxcrypt_fskit::FSKitBackend;
