...
//! `FuseBackend` from `oxcrypt-fuse`. Otherwise, it provides a stub
...
//!
//! ```bash
//! cargo build -p oxcrypt-desktop --features fuse
//! ```

// When the fuse feature is enabled, re-export from oxcrypt-fuse
#[cfg(feature = "fuse")]
pub use oxcrypt_fuse::FuseBackend;
