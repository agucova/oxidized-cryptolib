...
│       ▼                                                         │
│  oxidized-fskit (Rust) ◄── This crate                           │
│       │                                                         │
│       ▼                                                         │
...
| Feature | oxidized-fskit | oxidized-fuse |
|---------|----------------|---------------|
...
For macOS users on 15.4+, oxidized-fskit is recommended as it uses Apple's native
filesystem API. For Linux users or older macOS versions, use oxidized-fuse.
