...
///
/// ```
/// use oxidized_mount_common::path_mapper::{PathTable, PathEntry, EntryKind};
...
/// let kind = EntryKind::Directory { dir_id: oxidized_cryptolib::vault::path::DirId::from_raw("abc") };
///
    ...
    Entry: Send + Sync,
{
    ...
    ///
    /// ```
    /// use oxidized_mount_common::path_mapper::{PathTable, PathEntry};
    ///
    /// // FUSE: root=1, first=2
