...
fn test_dir_entry_accessors() {
    use oxidized_cryptolib::vault::DirEntry;
...
fn test_create_directory_all() {
    ...
    assert_eq!(vault_ops.entry_type("a"), Some(oxidized_cryptolib::vault::path::EntryType::Directory));
    assert_eq!(vault_ops.entry_type("a/b"), Some(oxidized_cryptolib::vault::path::EntryType::Directory));
    assert_eq!(vault_ops.entry_type("a/b/c"), Some(oxidized_cryptolib::vault::path::EntryType::Directory));
    assert_eq!(vault_ops.entry_type("a/b/c/d"), Some(oxidized_cryptolib::vault::path::EntryType::Directory));
    ...
    assert_eq!(vault_ops.entry_type("a/b/e"), Some(oxidized_cryptolib::vault::path::EntryType::Directory));
}
...
fn test_touch() {
    ...
    assert_eq!(vault_ops.entry_type("newfile.txt"), Some(oxidized_cryptolib::vault::path::EntryType::File));
...
fn test_rename_directory_by_path() {
    ...
    assert_eq!(
        ...
        Some(oxidized_cryptolib::vault::path::EntryType::Directory)
    );
...
fn test_symlink_by_path_operations() {
    ...
    assert_eq!(
        ...
        Some(oxidized_cryptolib::vault::path::EntryType::Symlink)
    );
