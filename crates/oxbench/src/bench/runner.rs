...
use crate::results::{compute_stats, BenchmarkPrinter, LiveProgressReporter};
        ...
        for (impl_idx, &impl_type) in self.config.implementations.iter().enumerate() {
            ...
            match impl_type {
                Implementation::OfficialCryptomator => {
                    tracing::debug!("Validating Cryptomator mount at {}", mount_point.display());
                }
                _ => {
                    tracing::debug!("Mounting {} at {}", impl_type, mount_point.display());
                }
            }
            ...
            for benchmark in benchmarks {
                ...
                // Create live progress reporter for this benchmark
                ...
                // Finish progress and print result immediately
                reporter.finish();
