//! Common test infrastructure for FSKit integration tests.
//!
//! Provides the `TestMount` harness and assertions for testing
//! the FSKit filesystem through actual kernel mounts.
...
// Macros (skip_if_no_fskit!, require_mount!) are #[macro_export] so they're
